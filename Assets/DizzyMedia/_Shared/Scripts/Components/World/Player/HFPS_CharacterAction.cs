...
namespace DizzyMedia.Shared {
            ...
            if(hfpsUI.gameUIStateStart == Action_State.Nothing){
                ...
                if(hfpsUI.useDisplaySet){
                    ...
                    if(hfpsUI.displaySet != ""){
                        ...
                        HFPS_UICont.instance.DisplaySet_State(false, hfpsUI.displaySet);
                    ...
                    if(userOptions.actionAttribute == ActionAttribute.Teleport){
                        ...
                        if(teleportType == Teleport_Type.Level){
                            ...
                            if(saveState == Save_State.Active){
                                ...
                                HFPS_UICont.instance.Save_Init(true);
                            ...
                            yield return new WaitForSeconds(0.4f);
                                ...
                                HFPS_GameManager.Instance.ChangeScene_Loader(levelName, (int)loadState);
            ...
            if(hfpsUI.gameUIStateStart == Action_State.Nothing){
                ...
                if(hfpsUI.useDisplaySet){
                    ...
                    if(hfpsUI.displaySet != ""){
                        ...
                        HFPS_UICont.instance.DisplaySet_State(true, hfpsUI.displaySet);
        ...
        public void SubActions_Update(bool state){
                ...
                if(state){
                    ...
                    if(HFPS_SubActionsUI.instance != null){
                        ...
                        HFPS_SubActionsUI.instance.ActionHolders_Reset();

                        for(int sa = 0; sa < auto.refs.subActionsHandler.subActions.Count; sa++) {

                            if(auto.refs.subActionsHandler.subActions[sa].isActive){

                                HFPS_SubActionsUI.instance.ActionHolder_Update(auto.refs.subActionsHandler.subActions[sa].inputSlot, auto.refs.subActionsHandler.subActions[sa].display, auto.refs.subActionsHandler.subActions[sa].icon);
    ...
    ///////////////////////////////
            ...
            if(state){
                ...
                if(autoExtensions.actionBar != null){
                    ...
                    if(extensions.actionBarSettings.actions.Count > 0){
                        ...
                        for(int a = 0; a < extensions.actionBarSettings.actions.Count; a++) {

                            int tempInt = a;

                            autoExtensions.actionBar.ActionTexts_Add(extensions.actionBarSettings.actions[a].text);
                            autoExtensions.actionBar.actions[a].onActionInit.AddListener(() => ActionBar_EventInvoke(tempInt));
                    ...
                    //actions.Count > 0
                        ...
                        autoExtensions.actionBar.ActionTexts_Add("Null");
                ...
                if(autoExtensions.actionBar != null){
                    ...
                    if(extensions.actionBarSettings.actions.Count > 0){
                        ...
                        for(int a = 0; a < extensions.actionBarSettings.actions.Count; a++) {
                            ...
                            autoExtensions.actionBar.ActionTexts_Remove(extensions.actionBarSettings.actions[a].text);
                            autoExtensions.actionBar.actions[tempInt].onActionInit.RemoveAllListeners();
                    ...
                    //actions.Count > 0
                        ...
                        autoExtensions.actionBar.ActionTexts_Remove("Null");
        ...
        private void ActionBar_EventInvoke(int slot){

            extensions.actionBarSettings.actions[slot].actionInit.Invoke();

        }//ActionBar_EventInvoke
    ...
    ///////////////////////////////
        ...
        public void Audio_State(bool play){
                ...
                if(play){
                    ...
                    if(audioOptions.audioType == AudioType.Music){
                        ...
                        if(audioOptions.customVolume){
                            ...
                            HFPS_AudioFader.instance.Fade_Start(HFPS_AudioFader.FadeType.Music, audioOptions.clip, audioOptions.audioVolume, audioOptions.keepAmbience, audioOptions.immediate);

                        //customVolume
                        } else {

                            HFPS_AudioFader.instance.Fade_Start(HFPS_AudioFader.FadeType.Music, audioOptions.clip, 0, audioOptions.keepAmbience, audioOptions.immediate);
                    ...
                    if(audioOptions.audioType == AudioType.Ambience){
                        ...
                        if(audioOptions.customVolume){
                            ...
                            HFPS_AudioFader.instance.Fade_Start(HFPS_AudioFader.FadeType.Ambience, audioOptions.clip, audioOptions.audioVolume, audioOptions.keepAmbience, audioOptions.immediate);

                        //customVolume
                        } else {

                            HFPS_AudioFader.instance.Fade_Start(HFPS_AudioFader.FadeType.Ambience, audioOptions.clip, 0, audioOptions.keepAmbience, audioOptions.immediate);
                ...
                //play
                    ...
                    HFPS_AudioFader.instance.Fade_Revert();
    ...
    ///////////////////////////////////////
        ...
        private IEnumerator Save_Buff(){
            ...
            HFPS_UICont.instance.Save_Init(false);
