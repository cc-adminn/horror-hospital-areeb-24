...
namespace HFPS.Systems
{
    ...
    public class OptionsController : Singleton<OptionsController>
    {
        ...
        object GetOptionDefault(OptionType option)
        {
            ...
            {
                int val = (int)ControlFreak2.CFScreen.fullScreenMode;
        ...
        public void ApplyResolution(int index, int fullscreen)
        {
            if (index > -1)
            {
                ...
                {
                    ControlFreak2.CFScreen.SetResolution(resolution.width, resolution.height, fullScreenMode, resolution.refreshRate);
                }
                else
                {
                    ControlFreak2.CFScreen.SetResolution(resolution.width, resolution.height, fullScreenMode);
                }
            }
            ...
            {
                FullScreenMode fullScreenMode = fullscreen == 0 ? FullScreenMode.ExclusiveFullScreen : fullscreen == 1 ? FullScreenMode.FullScreenWindow : FullScreenMode.Windowed;
                ControlFreak2.CFScreen.fullScreenMode = fullScreenMode;
            }
        }
