...
namespace HFPS.Player
{
    public class DynamicObjectController : MonoBehaviour
    {
        ...
        void FirstPass()
        {
            ...
            if (InputHandler.CurrentDevice.IsGamepadDevice() == 1)
                gameManager.LockPlayerControls(false, false, true, false);
